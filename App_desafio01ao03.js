...
function App() {
  return (
    <View style={{ flex: 1, backgroundColor: 'orange', margin: 10 }}>
      ...
      <View style={{
        alignItems: 'center', backgroundColor: '#5f9ea0',
      ...
      <View style={{
        ...
        <Text style={{
          fontSize: 15, color: 'gray', marginBottom: 20, width: '70%',
          textAlign: 'justify'
        }}>
  ...
  <Image
  source={{ uri: 'https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg' }}
  style={{ width: 200, height: 100 }}
/>
  
  <View style={{ flexDirection: 'row' }}>
    <Text>Camila Marques - 2026</Text>
  </View>
</View>
    </View>
  );
